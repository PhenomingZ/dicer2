...
class QueueMessage(object):
    ...
    def __init__(self, job_id, job_name, start_time, job_status, data=None):
        """
        初始化消息队列信息实例
        :param job_id: 任务的id
...
class JobQueuePutter(object):
    ...
    def __init__(self, job_id, job_name, queue, start_time):
        """
        初始化meta信息
        :param job_id: 任务的id
        :param job_name: 任务的名称
        ...
        self.meta = QueueMessage(job_id, job_name, start_time, JobStatus.DEFAULT)
...
class JobStartedQueuePutter(JobQueuePutter):
    def __init__(self, job_id, job_name, queue, start_time):
        super().__init__(job_id, job_name, queue, start_time)
